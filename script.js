...
// canvasの背景色
app.renderer.backgroundColor = 0x9d6161;

// ゲームで使用する画像をあらかじめ読み込んでおく(プリロードという)
PIXI.loader.add("alba.png");
...
PIXI.loader.load((loader, resources) => {
    ...
    function createGameScene() {
        ...
        const ball = new PIXI.Sprite(resources["alba.png"].texture); //引数には、プリロードしたURLを追加する
        ball.x = 200; // x座標
        ball.y = 500; // y座標
        ...
        const text = new PIXI.Text("院試SCORE:0", textStyle); //スコア表示テキスト
    ...
    function createEndScene() {
        ...
        // テキストオブジェクトの定義
        const text = new PIXI.Text(`SCORE:${score}で力尽きた
アルバさんは院試に落ちた`, textStyle); // 結果画面のテキスト
